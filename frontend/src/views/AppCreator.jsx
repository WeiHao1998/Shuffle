...
const AppCreator = (defaultprops) => {
  ...
  const submitApp = () => {
    ...
    if (basedata.info !== undefined && basedata.info.contact !== undefined) {
      ...
      data.info["contact"] = {
        name: "@Anonymous Zebra Axon User",
        ...
        for (let querykey in paths) {
      	...
      	if (
      	  ...
      	  item.body.length > 0
					...
					// This is to stop it from messing with systems in Zebra Axon.
      	  ...
      	  data.paths[item.url][item.method.toLowerCase()]["requestBody"] = {
      	    description: "Generated by Zebra Axon",
      	    required: required,
      	    content: {
      	      example: {
      	        example: item.body,
      ...
      <div style={{ color: "white", marginTop: 20 }}>
        ...
        >
			{oauth2Type === "delegated" ?
				"Find the Authorization URL, Token URL and scopes in question for the API. "
				:
