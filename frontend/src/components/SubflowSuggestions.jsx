...
const SubflowSuggestions = (props) => {
	...
	//currently only supports  figure out a way to support more apps
		...
		const workflowDescription = "Generated by Zebra Axon for sending info/error notifications."
		const data = {
			"name": workflowName,
					...
					<>
						...
						<Box mt={2}>
							...
							<TextField
								...
								margin="normal"
								variant="outlined"
								placeholder={ selectedAppDetails.name.toLowerCase() === "jira" ? "Project key" : "Zebra Axon API key"}
